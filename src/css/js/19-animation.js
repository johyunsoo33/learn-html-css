document.addEventListener('DOMContentLoaded', function () {
	...
	document.querySelector('.crazy').addEventListener('click', startcrazy);
	function startcrazy() {
		toggleButtons.forEach((button) => {
			button.click();
		});
		document.querySelector('.crazy').innerHTML = `전체 ${toggleButtons[0].innerHTML}`;
	}
	document.querySelector('.sudoinit').addEventListener('click', sudoinit);
	function sudoinit() {
